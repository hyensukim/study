...
![Alt text](../../Servlet%20&%20JSP1/%EC%82%AC%EC%A7%84/function%20%ED%8C%A8%ED%82%A4%EC%A7%80%20%EC%A3%BC%EC%9A%94%20%ED%95%A8%EC%88%98%ED%98%95%20%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4.jpg)
...
### Function의 합성
- 두 람다식을 **합성**하여 새로운 람다식을 만들 수 있다.
- 두 함수의 합성은 어느 함수를 먼저 적용하느냐에 따라 달라진다.
- f,g가 있는경우 f.andThen(g)는 함수 f를 먼저 적용 후 함수 g를 적용한다.
- f.compose(g)는 함수 g를 먼저 적용 후 함수 f를 적용한다.
```
